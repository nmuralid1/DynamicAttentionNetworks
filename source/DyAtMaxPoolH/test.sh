...
time python -B $SOURCEDIR/test.py $DATAINPUTDIR $RNNOBJECT $LOGOUTPUTFILE $LOGLEVEL $PREDICTIONSOUTPUTDIR $HIDDENSIZE $BATCHSIZE $NUMLAYERS $SEQUENCELENGTH $SLIDINGATTENTION $SOSTOKEN $DROPOUT $TEACHERFORCING $ITERNUM $DATASETNAME $HIERARCHICAL_ATTN_METHOD $SLIDING_WINDOWSIZE 
