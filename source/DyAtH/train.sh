...
DROPOUT=$3	    
ITERNUM=$5          
echo datainputdir "$DATAINPUTDIR"
time python -B $SOURCEDIR/train.py $DATAINPUTDIR $TRAININGFILENAME $RNNOBJECT $LOGOUTPUTFILE $LOGLEVEL $PREDICTIONSOUTPUTDIR $HIDDENSIZE $BATCHSIZE $NUMLAYERS $TEACHERFORCING $LEARNINGRATE $SEQUENCELENGTH $SLIDINGATTENTION $SOSTOKEN $NUMEPOCHS $DROPOUT $ITERNUM $DATASETNAME $HIERARCHICAL_ATTN_METHOD
